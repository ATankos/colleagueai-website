...
const UI = {
  "en": {
    ...
    "governanceDesc": "Review security, data handling, AI governance, and telemetry.",
  ...
  "cs": {
    ...
    "governanceDesc": "Zkontrolujte bezpečnost, nakládání s daty, AI governance a telemetrii.",
  ...
  "de": {
    ...
    "governanceDesc": "Prüfen Sie Sicherheit, Datenverarbeitung, KI-Governance und Telemetrie.",
    ...
    "faqKicker": "Fragen und Antworten",
  ...
  "fr": {
    ...
    "governanceDesc": "Examinez sécurité, traitement des données, gouvernance IA et télémétrie.",
    ...
    "faqKicker": "Questions et réponses",
  ...
  "es": {
    ...
    "governanceDesc": "Revisa seguridad, manejo de datos, gobernanza de IA y telemetría.",
  ...
  "it": {
    ...
    "governanceDesc": "Rivedi sicurezza, gestione dati, governance AI e telemetria.",
  ...
  "pl": {
    ...
    "governanceDesc": "Sprawdź bezpieczeństwo, obsługę danych, governance AI i telemetrię.",
  ...
  "pt": {
    ...
    "governanceDesc": "Revise segurança, tratamento de dados, governança de IA e telemetria.",
    ...
    "faqKicker": "Perguntas e respostas",
...
function patchAgentLocalizedText(html, locale) {
  ...
  const replacements = [
    ...
    ["Review security, data handling, AI governance, and telemetry.", t.governanceDesc],
