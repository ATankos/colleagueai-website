...
/* === ColleagueAI - ONE unified header on every page (2026-07) === */
(function () {
  var MENU = {
  ...
  function build(){
    ...
    h.innerHTML='<div class="cai-uni-bar"><a class="cai-uni-logo" href="'+cfg.home+'"><span class="cai-uni-word">Colleague<b>AI</b></span><span class="cai-uni-dots"><i></i><i></i><i></i></span></a><nav class="cai-uni-links">'+links+lang+demo+'</nav><button class="cai-uni-burger" aria-label="Menu" aria-expanded="false"><span></span><span></span><span></span></button></div><nav class="cai-uni-mnav">'+links+demo+'<div class="cai-uni-mlang">'+lang+"</div></nav>";
